  ...
  return (
    <div className="container px-4 md:px-6 py-12 md:py-24">
      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        >
          <div className="bg-card/50 backdrop-blur-sm p-8 rounded-xl border border-border h-full">
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="p-2 bg-card rounded-full hover:bg-muted transition-colors">
          ...
          <div className="bg-card/50 backdrop-blur-sm p-8 rounded-xl border border-border">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {submitStatus === "success" && (
                <div className="p-4 bg-green-500/20 border border-green-500/50 rounded-md text-center">
